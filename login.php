...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  if ($user && password_verify($pass, $user['password'])) {
    ...
    if ($user['role'] === 'admin') {
      ...
      // FIX: redirect regular users to dashboard.php (student dashboard)
...
<head>
  ...
  <title>Login – ADBU Azara Student Events</title>
  ...
  <style>
    ...
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .form-label { display: block; font-size: 0.78rem; font-weight: 600; color: var(--text2); margin-bottom: 0.4rem; letter-spacing: 0.03em; transition: color 0.4s; }
    ...
    [data-theme="dark"] .submit-btn:hover { box-shadow: 0 6px 20px rgba(74,159,212,0.25); }
    ...
    .switch-text { text-align: center; font-size: 0.82rem; color: var(--text2); margin-top: 1.2rem; transition: color 0.4s; }
    .switch-text a { color: var(--accent); text-decoration: none; font-weight: 600; transition: opacity 0.2s; }
    .switch-text a:hover { opacity: 0.75; text-decoration: underline; }

    .admin-access { margin-top: 1rem; display: flex; align-items: center; justify-content: center; gap: 0.5rem; padding: 0.65rem 1rem; border: 1px dashed var(--border); border-radius: 9px; font-size: 0.78rem; color: var(--text3); transition: border-color 0.4s, color 0.4s; }
    .admin-access a { color: var(--accent2); text-decoration: none; font-weight: 600; font-size: 0.78rem; }
    ...
    .footer-copy { font-size: 0.76rem; color: var(--footer-text); }
    .footer-copy strong { color: var(--accent2); }
    .footer-dev { font-size: 0.72rem; color: var(--footer-text); letter-spacing: 0.04em; }
  ...
  <div class="login-wrapper">
    <form action="login.php" method="POST">
      <div class="login-card">
        ...
        <div class="card-sub">Sign in to access your student events dashboard.</div>
        ...
        <div class="form-group">
          ...
          <div class="input-wrap">
            ...
            <input class="form-input" type="text" name="email" placeholder="student@adbu.in" required>
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="input-wrap">
            ...
            <input class="form-input" type="password" name="password" id="passwordInput" required>
        ...
        <div class="switch-text">Don't have an account? <a href="register.php">Register here</a></div>
        <div class="admin-access"><span>⚙</span> Faculty / Staff? <a href="admin.php">Access Admin Portal</a></div>
      </div>
    </form>
  </div>
</main>
...
<script>
  ...
  function togglePw() { const inp = document.getElementById('passwordInput'); inp.type = inp.type === 'password' ? 'text' : 'password'; }
</script>
</body>
</html>